...
// function test(){
//     VoiceRSS.speech({
//         key: '9591d78f13d1452fbe4b604828c783ad',
//         src: 'Hello, world!',
//         hl: 'en-us',
//         v: 'Linda',
//         r: 0, 
...
audioElement.addEventListener('play', function disableButton(){
    button.toggleAttribute('disabled')
})
audioElement.addEventListener('ended', function disableButton(){
    button.toggleAttribute('disabled')
})
